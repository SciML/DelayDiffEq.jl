...
@testset "single constant delay" begin
  ## Scalar function
  sol_scalar = solve(DDEProblemLibrary.prob_dde_constant_1delay_scalar, alg; dt = 0.1)
  ...
  sol_oop = solve(DDEProblemLibrary.prob_dde_constant_1delay_oop, alg; dt = 0.1)

  @test sol_scalar.t ≈ sol_oop.t && sol_scalar.u ≈ sol_oop[1, :]

  ## In-place function
  sol_ip = solve(DDEProblemLibrary.prob_dde_constant_1delay_ip, alg; dt=0.1)
...
@testset "two constant delays" begin
  ## Scalar function
  sol_scalar = solve(DDEProblemLibrary.prob_dde_constant_2delays_scalar, alg; dt = 0.1)
  ...
  ## Out-of-place function
  sol_oop = solve(DDEProblemLibrary.prob_dde_constant_2delays_oop, alg; dt=0.1)

  @test sol_scalar.t ≈ sol_oop.t && sol_scalar.u ≈ sol_oop[1, :]

  ## In-place function
  sol_ip = solve(DDEProblemLibrary.prob_dde_constant_2delays_ip, alg; dt=0.1)
