@verbosity_specifier DDEVerbosity begin
    toggles = (
        ...
        :discontinuity_tracking, :delay_evaluation, :constrained_step, :residual_control,
...
- `SciMLLogging.All()`: Maximum verbosity
    ...
    DDEVerbosity(; preset=nothing, error_control=nothing, performance=nothing, numerical=nothing, sensitivity=nothing, delay_specific=nothing, kwargs...)
