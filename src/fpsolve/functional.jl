...
function compute_step_fixedpoint!(
    fpsolver::FPSolver{<:Union{NLFunctional,NLAnderson},false},
    integrator::DDEIntegrator,
)
    ...
    atmp = OrdinaryDiffEq.calculate_residuals(
        dz,
        ode_integrator.u,
        integrator.u,
        opts.abstol,
...
function compute_step_fixedpoint!(
    fpsolver::FPSolver{<:Union{NLFunctional,NLAnderson},true},
    integrator::DDEIntegrator,
)
    @unpack t, opts = integrator
    @unpack cache = fpsolver
